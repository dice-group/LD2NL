...
public class VerbalizerTest {
  ...
  /**
   * Test method for
   * {@link org.aksw.avatar.Verbalizer#summarize(org.dllearner.core.owl.Individual)}.
   */
  @Test
  public void testSummarizeIndividual() {
    try {
      ...
      final OWLIndividual ind =
          new OWLNamedIndividualImpl(IRI.create("http://dbpedia.org/resource/Albert_Einstein"));

      // compute summarization of the entity and verbalize it
      final String summary = verbalizer.summarize(ind);
  ...
  /**
   * Test method for
   * {@link org.aksw.avatar.Verbalizer#summarize(org.dllearner.core.owl.Individual, org.dllearner.core.owl.NamedClass)}.
   */
  @Test
  public void testSummarizeIndividualNamedClass() {
    try {
      // define the class of the entity
      final OWLClass cls = new OWLClassImpl(IRI.create("http://dbpedia.org/ontology/Scientist"));
      ...
      // compute summarization of the entity and verbalize it
      final String summary = verbalizer.summarize(ind, cls);
      System.out.println(summary);
