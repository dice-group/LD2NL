...
public class GeneralGenderDictionary extends GenderDictionary {
	...
	public static String MALE_GENDER_FILE_LOCATION = "../LD2NL/avatar/src/main/resources/gender/male.txt";
	public static String FEMALE_GENDER_FILE_LOCATION = "../LD2NL/avatar/src/main/resources/gender/female.txt";
